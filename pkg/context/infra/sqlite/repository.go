...
func toDomain(row contextRow) *domain.Context {
...
func (r *Repository) Create(ctx context.Context, contextObj *domain.Context) error {
...
func (r *Repository) Get(ctx context.Context, id string) (*domain.Context, error) {
...
func (r *Repository) List(ctx context.Context, q domain.ListQuery) ([]*domain.Context, error) {
...
func (r *Repository) Update(ctx context.Context, contextObj *domain.Context) error {
	if err := contextObj.Validate(); err != nil {
		return err
	}
