...
func toDomain(row actionRow) (*domain.Action, error) {
...
func (r *Repository) Create(ctx context.Context, action *domain.Action) error {
...
func (r *Repository) Get(ctx context.Context, id string) (*domain.Action, error) {
	const q = `
...
func (r *Repository) List(ctx context.Context, q domain.ListQuery) ([]*domain.Action, error) {
...
func (r *Repository) Update(ctx context.Context, action *domain.Action) error {
	if err := action.Validate(); err != nil {
		return err
	}
	contextIDs, err := marshalContextIDs(action.ContextIDs)
...
func (r *Repository) ConvertFromInbox(ctx context.Context, inboxID string, title, description *string, kind *domain.Kind, projectID *string, contextIDs []string, labels []domain.Label, attributes *domain.Attributes, now time.Time) (*domain.Action, error) {
