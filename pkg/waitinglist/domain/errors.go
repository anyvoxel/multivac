// Package domain contains core business concepts for Waiting List.
package domain
...
var (
	// ErrNotFound is returned when a Waiting List item does not exist.
	ErrNotFound = errors.New("waiting list not found")
