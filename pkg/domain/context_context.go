...
func (c *Context) Validate() error {
	...
	if err := requiredFieldsError(requiredContextField(c.ID, "id"), requiredContextField(c.Title, "title"), requiredContextField(c.Color, "color")); err != nil {
		return err
	}
...
func requiredContextField(value, field string) string {
