...
func InvalidColor(value string) error                  { return invalidFieldValueError("color", value) }
func InvalidStatus(value string) error                 { return invalidFieldValueError("status", value) }
