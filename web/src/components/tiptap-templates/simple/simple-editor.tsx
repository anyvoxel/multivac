...
function parseEditorContent(content?: string): JSONContent | string {
  if (content === undefined) {
    return defaultContent as JSONContent
  }
...
export function SimpleEditor({
  ...
  const initialContent = useMemo(() => parseEditorContent(content), [content])
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        ...
        class: ["simple-editor", editorClassName].filter(Boolean).join(" "),
      },
    },
    extensions: [
  ...
  useEffect(() => {
    ...
    editor.commands.setContent(parseEditorContent(content), { emitUpdate: false })
  }, [content, editor])
